    ...
    [
        {
            ...
            id: "hubHotel",
            title: "Hub Hotel",
            link: "https://hub.5erg10.com",
            description: "El usuario puede recorer diferentes oficinas y puede ver en tiempo real a otros usuarios y chatear con ellos.",
            resume: "<p>Aplicaciòn creda con <b>ThreeJs</b> y <b>WebSocket</b> para la comunicaciòn en tiempo real.</p><br><p>El usuario se conecta a la aplicaciòn, configura su avatar y seleccioa una de las diferentes sedes de la empresa que podrà recorrer para conocer los diferentes puntos de interès</p><br><p>El objetivo era ofrecer a los empleados de la empresa una forma divertida de familiarizarse con la sede, sobre todo si trabajan fuera de ella y algùn dia necesitan ir para cualquier gestion, por lo que el recorrido le ofrece informacion de las diferentes areas y la posibilidad de poder encontrarse en tiempo real con otros usuarios que esten conectados con los que poder chatear.</p>",
