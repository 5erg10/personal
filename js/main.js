	...
	.then(res => res.json())
  	.then(response => {
		...
		const responseOptions = {
			...
			proyectos: `Estoy trabajando en la mejor forma de contarte los proyectos en los que Sergio ha trabajado relacionados con ${tecnologiaConsultada}. De momento, te puedo recomendar que pinches <a href="#portfolio">aqui</a> para navegar a la sección de proyectos.`,
